...
#   Спробуємо порахувати наступний паліндром
#
#
# list1 = [1,2,3,4,5,6]
# incremented_list = [x+170 for x in list1]
...
#
# next_palindrome = first + center_next + end
# print(next_palindrome)
#
# # перетворюємо список на число
# print(list_to_number(palindrome))
#
#
# #змінюємо позицію ліворуч від центра
#
# center_to_left = first[-1]
# print(center_to_left)
# center_to_left += 1
# print(center_to_left)
# first[1] = center_to_left
# print(first)
#
# # формуємо наступний паліндром з новим числом лівіше від центру
#
# next_palindrome = first + center_next + end
# print(next_palindrome)
#
# # перетворюємо список на число
# print(list_to_number(next_palindrome))
#
# #змінюємо позицію ще лівіше від центру
# center_to_left2 = first[-2]
# print(center_to_left2)
# center_to_left2 += 1
# print(center_to_left2)
# first[0] = center_to_left2
# print(first)
#
# # формуємо наступний паліндром з новим числом лівіше від центру
#
# next_palindrome2 = first + center_next + end
# print(next_palindrome2)
#
# # перетворюємо список на число
# print(list_to_number(next_palindrome2))
#
# print(int(list_to_number(next_palindrome2))-int(list_to_number(palindrome)))
# print(int(list_to_number(next_palindrome))-int(list_to_number(palindrome)))

#
# 25.10.2016 => продовжуємо роботу над Проектом
#
...
# print("end ", end)
#
# next_palindrome = first + center + end
# print("next_palindrome ", next_palindrome)
#
# # перетворюємо список на число
# print(list_to_number(next_palindrome))
#
# print("difference between initial lived.days and palindrome ", int(list_to_number(next_palindrome))-int(list_to_number(palindrome)))
#
# print("lived.days ", lived.days)
